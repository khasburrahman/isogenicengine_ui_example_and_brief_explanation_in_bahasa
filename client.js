		...
		ige.on('texturesLoaded', function () {
			...
			ige.start(function (success) {
				...
				if (success) {
					...
					//berisikan style untuk komponen IGE UI,
					//beberapa mirip dengan css pada html: https://www.youtube.com/watch?time_continue=3&v=c2YGsbgcaIU
					//peletakan komponen berdasarkan method (mount) yang ada ketika membuat UI element
					//pada program ini ada self.uiScene (utama), main, leftNav, dan topNav
					//peletakan posisi berdasarkan nilai style top, left, width bottom, berdasar posisi mount
					//contohnya untuk meletakkan komponen main yang di mount pada self.uiScene style top bernilai 42
					//karena ada komponen topNav yang diletakkan juga pada self.uiScene dengan height 42
					ige.ui.style('#topNav', {
					...
					//mencoba membuat efek hover pada elemen ketika mouse hover 
					//ketika hover maka membuat warna latar menjadi hex rrggbb: 221111
					ige.ui.style('#topNav:hover', {
						'backgroundColor': '#221111'
					})

					ige.ui.style('#leftNav:hover', {
						'backgroundColor': '#221111'
					})

					ige.ui.style('#main:hover', {
						'backgroundColor': '#221111'
					})
					

					//komponen yang diletakkan pada scene
